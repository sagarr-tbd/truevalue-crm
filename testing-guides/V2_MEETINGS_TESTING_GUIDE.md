...
### Permission Codes (Activities — Meetings)

| Code | Description |
|------|-------------|
| `activities:read` | View meetings list and detail pages |
| `activities:write` | Create, edit, mark complete meetings |
| `activities:delete` | Delete meetings (single and bulk) |
...
- Meetings use **soft delete** — deleted meetings are hidden from the UI but retained in the database
